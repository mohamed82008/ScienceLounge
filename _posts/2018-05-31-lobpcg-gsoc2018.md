...
<p>Strain is a measure of deformation. For 1D structures such as a spring, <em>strain</em> is often treated as a linear function of how much the tip of the spring has moved. More specifically, it is defined as the ratio of the displacement of the tip and the length of the unloaded spring. This however is only true under the assumption of small strain. More correctly and generally for 2D and 3D structures, the strain, also known as the Green-Lagrange strain, is defined using the following formula:</p>
